    	   ...
    	   <div class="row">
            ...
            <div class="col-12">
				...
				<table class="table table-sm">
					<tr>
	  					<td class="align-middle">WAN IP / Cloud DDNS </td><td><input class="form-control" type="text" size="15" name="ipmik" title="IP MikroTik / IP Cloud MikroTik" value="<?= $iphost; ?>" required="1"/></td>
					</tr>
					<tr>
...
<div class="col-12">
	<div class="card">
        <div class="card-header">
            <h3 class="card-title">SSM Router Data</h3>
        </div>
    <div class="card-body">    
	<table class="table table-sm">
	<tr>
